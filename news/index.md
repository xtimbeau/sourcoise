...
- force l’encodage à être selon l’otion `sourcoise.encoding` et à être
  `UTF-8` pour foncitonner sur le multiplateforme avec macOS et windows
