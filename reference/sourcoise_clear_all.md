...
sourcoise_clear_all()
#> [1] "/tmp/RtmpedenZW/.sourcoise/some_data-4262323b_f6b2fe0a-1.json"
#> [2] "/tmp/RtmpedenZW/.sourcoise/some_data-4262323b_f6b2fe0a-2.json"
#> [3] "/tmp/RtmpedenZW/.sourcoise/some_data-4262323b_f6b2fe0a-3.json"
#> [4] "/tmp/RtmpedenZW/.sourcoise/some_data-4262323b_f6b2fe0a-4.json"
#> [5] "/tmp/RtmpedenZW/.sourcoise/some_data-4262323b_f6b2fe0a-5.json"
sourcoise_status()
#> ℹ No cache data
#> # A tibble: 0 × 0
```
