...
codes <- vroom::vroom(pathify("/work/data/ACTIVITY.codes.csv"))
...
melodi_cna_branches <- melodi::get_all_data("DD_CNA_BRANCHES")
...
fr_branches <- melodi_cna_branches |>
  filter(REF_SECTOR == "S1",
