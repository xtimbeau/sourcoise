...
#> /var/folders/sr/zcvrvtss0w75m9m9g2t0zrcr0000gn/T/Rtmp4ygd80
    setwd(tmp)
    file_copy(
...
#> 1 cache        6.81ms   7.33ms   1.27e+2    5.01MB   33.7  
#> 2 no_cache      1.01s    1.01s   9.88e-1    1.17MB    0.988
#> 3 direct            0      1ns   1.34e+9        0B    0
```

^(Created on 2025-12-11 with [reprex v2.1.1](https://reprex.tidyverse.org))
